...
void Next_Packet()
{
  ...
  for(;;)
  {
    ...
    case VIDEO_ELEMENTARY_STREAM:   
      ...
      ldData->Rdmax = ldData->Rdptr + code;
      ...
      if((code>>6)==0x02)
      {
        ...
        ldData->Rdptr+=code;    /* advance pointer by PES_header_data_length */
    ...
    case ISO_END_CODE: /* end */
      ...
      while (l<RDBFR_SIZE)
      {
        ldData->Rdbfr[l++] = SEQUENCE_END_CODE>>24;
        ldData->Rdbfr[l++] = SEQUENCE_END_CODE>>16;
        ldData->Rdbfr[l++] = SEQUENCE_END_CODE>>8;
        ldData->Rdbfr[l++] = SEQUENCE_END_CODE&0xff;
      }
      ldData->Rdptr = ldData->Rdbfr;
      ldData->Rdmax = ldData->Rdbfr + RDBFR_SIZE;
      return;
    default:
