...
/* CellInterface.c */
void InitCellInterface _ANSI_ARGS_ ((void));
void CloseCellInterface _ANSI_ARGS_ ((void));
void CellSync _ANSI_ARGS_ ((void));
void CheckAndSend _ANSI_ARGS_ ((void));
...
EXTERN struct layer_data base, /*enhan,*/ *ld;
EXTERN struct read_data baseData, /*enhanData,*/ *ldData;
...
EXTERN struct spuJobData *spuJobs;
EXTERN int numSPUs
